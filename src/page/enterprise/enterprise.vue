      ...
      <div slot="bd" class="content">
       ...
       <el-form ref="form" :model="enterprise" label-width="80px">
        ...
        <el-form-item label="成立时间">
            <el-date-picker type="date" placeholder="选择日期" v-model="enterprise.createdate" style="width: 100%;"></el-date-picker>
        </el-form-item>
         <Title>公司Logo</Title>
          <el-form-item label="公司Logo" class="required">
              ...
              :on-change="upload">
              <el-button size="small" type="primary"> <i class="el-icon-folder-add"></i>选择附件</el-button>
